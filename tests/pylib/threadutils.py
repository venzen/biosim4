...
class Signal():
    ...
    def __call__(self, sender, data, error_signal_on_error=True):
        """dispatch signal to all connected slots. This is a synchronous
        ...
        again. The lock will allow recursive re-entry of the same thread, this
